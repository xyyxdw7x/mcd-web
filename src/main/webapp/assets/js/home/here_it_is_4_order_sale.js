...
function load_channel(_cmd, _lct) {
	$.ajax({
		...
		success : function(result) {
			...
			$.ajax({
				url : _ctx + '/mpm/imcdChannelExecuteAction.aido?cmd=initAdivInfo',
				type : "POST",
				async:false,
				data : {},
				success : function(result) {
...
//			$(html).appendTo($(".content-main"));
			...
			$(".stick_on_top_cancel").bind("click",function(){
				...
				$.ajax({
					type:"post",
					url:_ctx +"/mpm/priorityAction.aido?cmd=cancleTopManualPriorityCampseg",
...
//							$('.adiv_tr .active').click();
			...
			$("#createDimPlanListUl").sortable({
				...
				stop:function(event, ui){
					...
					$.ajax({
						url : _ctx + "/mpm/priorityAction.aido?cmd=editManualPriorityCampseg",
						type : "POST",
						dataType:"json",
