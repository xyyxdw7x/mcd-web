function collectData913(event,data){
 ...
 * @param data
 */
function loadChannelBaseData913(data){
 ...
 * @param data
 */
function clickChannelContentEventHandler913(data){
	
	//确定按钮
	clickCommitButtonEventHandler913(data);
	
	//预览按钮
//	clickPreviewButtonEventHandler913(data);
}
 ...
 */
function clickCommitButtonEventHandler913(data){
	$("#commitButton_channelId_"+data.channelId).click(function(){
		var newdata = collectData913(this, data);
 ...
 * @param data
 */
//function clickPreviewButtonEventHandler913(data){
