function collectData908(event,data){
 ...
 * @param data
 */
function loadChannelBaseData908(data){
 ...
 * @param data
 */
function clickChannelContentEventHandler908(data){
	
	//确定按钮
	clickCommitButtonEventHandler908(data);
	
	//预览按钮
//	clickPreviewButtonEventHandler908(data);
}
 ...
 */
function clickCommitButtonEventHandler908(data){
	$("#commitButton_channelId_"+data.channelId).click(function(){
		var newdata = collectData908(this, data);
 ...
 * @param data
 */
//function clickPreviewButtonEventHandler908(data){
