function collectData902(event,data){
 ...
 * @param data
 */
function loadChannelBaseData902(data){
 ...
 * @param data
 */
function clickChannelContentEventHandler902(data){
	
	//确定按钮
	clickCommitButtonEventHandler902(data);
	
	//预览按钮
//	clickPreviewButtonEventHandler902(data);
}
 ...
 */
function clickCommitButtonEventHandler902(data){
	$("#commitButton_channelId_"+data.channelId).click(function(){
		var newdata = collectData902(this, data);
 ...
 * @param data
 */
//function clickPreviewButtonEventHandler902(data){
