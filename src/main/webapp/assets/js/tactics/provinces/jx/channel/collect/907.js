function collectData907(event,data){
 ...
 * @param data
 */
function loadChannelBaseData907(data){
 ...
 * @param data
 */
function clickChannelContentEventHandler907(data){
	
	//确定按钮
	clickCommitButtonEventHandler907(data);
	
	//预览按钮
//	clickPreviewButtonEventHandler907(data);
}
 ...
 */
function clickCommitButtonEventHandler907(data){
	$("#commitButton_channelId_"+data.channelId).click(function(){
		var newdata = collectData907(this, data);
 ...
 * @param data
 */
//function clickPreviewButtonEventHandler907(data){
