function collectData903(event,data){
 ...
 * @param data
 */
function loadChannelBaseData903(data){
 ...
 * @param data
 */
function clickChannelContentEventHandler903(data){
	
	//确定按钮
	clickCommitButtonEventHandler903(data);
	
	//预览按钮
//	clickPreviewButtonEventHandler903(data);
}
 ...
 */
function clickCommitButtonEventHandler903(data){
	$("#commitButton_channelId_"+data.channelId).click(function(){
		var newdata = collectData903(this, data);
 ...
 * @param data
 */
//function clickPreviewButtonEventHandler903(data){
