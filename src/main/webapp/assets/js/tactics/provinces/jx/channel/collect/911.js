function collectData911(event,data){
 ...
 * @param data
 */
function loadChannelBaseData911(data){
 ...
 * @param data
 */
function clickChannelContentEventHandler911(data){
	
	//确定按钮
	clickCommitButtonEventHandler911(data);
	
	//预览按钮
//	clickPreviewButtonEventHandler911(data);
}
 ...
 */
function clickCommitButtonEventHandler911(data){
	$("#commitButton_channelId_"+data.channelId).click(function(){
		var newdata = collectData911(this, data);
 ...
 * @param data
 */
//function clickPreviewButtonEventHandler911(data){
