function collectData904(event,data){
 ...
 * @param data
 */
function loadChannelBaseData904(data){
 ...
 * @param data
 */
function clickChannelContentEventHandler904(data){
	
	//确定按钮
	clickCommitButtonEventHandler904(data);
	
	//预览按钮
//	clickPreviewButtonEventHandler904(data);
}
 ...
 */
function clickCommitButtonEventHandler904(data){
	$("#commitButton_channelId_"+data.channelId).click(function(){
		var newdata = collectData904(this, data);
 ...
 * @param data
 */
//function clickPreviewButtonEventHandler904(data){
