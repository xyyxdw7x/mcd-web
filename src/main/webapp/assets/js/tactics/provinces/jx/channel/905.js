function collectData905(event,data){
 ...
 * @param data
 */
function loadChannelBaseData905(data){
 ...
 * @param data
 */
function clickChannelContentEventHandler905(data){
	
	//确定按钮
	clickCommitButtonEventHandler905(data);
	
	//预览按钮
//	clickPreviewButtonEventHandler905(data);
}
 ...
 */
function clickCommitButtonEventHandler905(data){
	$("#commitButton_channelId_"+data.channelId).click(function(){
		var newdata = collectData905(this, data);
 ...
 * @param data
 */
//function clickPreviewButtonEventHandler905(data){
