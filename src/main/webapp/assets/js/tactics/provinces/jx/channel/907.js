 ...
 * 初始化值(编辑时)
 */
channelInfo907.initValue907 = function(){
	//如果有默认的推荐语则
	if(tacticsInfo.plan.planComment!=null&&tacticsInfo.plan.planComment!=undefined){
		$("#channelId_"+channelInfo907.baseInfo.channelId+"_contentWords").val(tacticsInfo.plan.planComment);
	}
...
channelInfo907.clickCommitButtonEventHandler907=function(){
	$("#commitButton_channelId_"+channelInfo907.baseInfo.channelId).click(function(){
		...
		if($("#commitButton_channelId_"+channelInfo907.baseInfo.channelId).hasClass("disable-href")){
			return ;
		}
...
channelInfo907.textAreaInputNumTip907=function(){
	...
	var $commitButton=$("#commitButton_channelId_"+channelInfo907.baseInfo.channelId);
