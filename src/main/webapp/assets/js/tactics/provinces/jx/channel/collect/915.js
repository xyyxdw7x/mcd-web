function collectData915(event,data){
...
function clickChannelContentEventHandler915(data){
	...
	//确定按钮
	clickCommitButtonEventHandler915(data);
	
	//预览按钮
//	clickPreviewButtonEventHandler915(data);
}
 ...
 */
function clickCommitButtonEventHandler915(data){
	$("#commitButton_channelId_"+data.channelId).click(function(){
		var newdata = collectData915(this, data);
 ...
 * @param data
 */
//function clickPreviewButtonEventHandler915(data){
