	...
	module.exports={
		...
		init:function(){
			...
			window.tableViewManage  = this.loadTable({
				...
				ejsUrl:_ctx + '/mcd/pages/EJS/tacticsManage/avoidBotherCustomer.ejs',
				ajaxData:{
					"isSelectMy":"0",
		...
		loadTable:function(options){
			var defaults = {
				urlRoot:_ctx+"/BotherAvoidList",
				id:"searchBotherAvoidUser",
				//cmd:"searchBotherAvoidUser",
				currentDom:"#avoidBotherCustomerTable",
				ejsUrl:_ctx + '/mcd/pages/EJS/tacticsManage/avoidBotherCustomer.ejs',
				ajaxData:{
					"sortColumn":$("#sortColumn").val(),
			...
			var avoidBathorTableView = Backbone.View.extend({
				...
				click : function(obj) {
					...
					}else if($target.hasClass("ui-page-buttsetDomListon")){
				...
				setDomList:function(pageNum,tableModel){
					...
					tableModel.on("change", function(model) {
						...
						var _Html1 = new EJS({
							url : _ctx + '/mcd/pages/EJS/tacticsManage/avoidBotherCustomerPage.ejs'
						}).render(model.attributes);
		...
		loadAvoidBotherUserType:function(options){
			var defaults = {
					urlRoot:_ctx+"/BotherAvoidList",
					id:"searchBotherAvoidUserType",
					currentDom:".avoidBotherUserType",
					ejsUrl:_ctx + '/mcd/pages/EJS/tacticsManage/avoidBotherUserType.ejs',
					ajaxData:{}
			};
			options = $.extend(defaults, options);
				...
				setDomList:function(md){
					...
					md.fetch({
						...
						success:function(model) {
							...
							var _Html1 = new EJS({
								url : _ctx + '/mcd/pages/EJS/tacticsManage/avoidBotherUserTypeSelect.ejs'
							}).render(model.attributes);
		...
		loadCampsegType:function(options) {
			var defaults = {
					urlRoot:_ctx+"/BotherAvoidList",
					id:"searchCampsegType",
					currentDom:".avoidBotherCampsegType",
					ejsUrl:_ctx + '/mcd/pages/EJS/tacticsManage/avoidBotherCampsegType.ejs',
					ajaxData:{}
			};
			options = $.extend(defaults, options);
			var searchCampsegStatModel = Backbone.Model.extend({
				...
				setDomList:function(md){
					...
					md.fetch({
						...
						success:function(model) {
							...
							$(options.currentDom).html(_Html);
							var _Html1 = new EJS({
								url : _ctx + '/mcd/pages/EJS/tacticsManage/avoidBotherCampsegTypeSelect.ejs'
							}).render(model.attributes);
		...
		addNewCustomer:function() {
			...
			$.ajax({
				url: _ctx+"/BotherAvoidList/addBotherAvoidUser",
				dataType: "json",
				async: true,
		...
		updateCustomer:function() {
			$.ajax({
				url: _ctx+"/BotherAvoidList/mdfBotherAvoidUser",
				dataType: "json",
				async: true,
		...
		removeCustomer:function() {
			$.ajax({
				url: _ctx+"/BotherAvoidList/delBotherAvoidUser",
				dataType: "json",
				async: true,
		...
		batchRemoveCustomer:function () {
			...
			$.ajax({
				url: _ctx+"/BotherAvoidList/batchDelBotherAvoidUser",
				dataType: "json",
				async: true,
