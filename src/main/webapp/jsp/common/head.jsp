...
<link type="text/css" href="<%=contextPath%>/assets/js/common/jqueryeasyui/themes/default/easyui.css" rel="stylesheet" />
<link type="text/css" href="<%=contextPath%>/assets/js/common/jqueryeasyui/themes/icon.css" rel="stylesheet" />
