...
<head>
	...
	<link type="text/css" rel="stylesheet/less" href="${ctx}/mcd/assets/styles/common.css" />
	<link type="text/css" rel="stylesheet/less" href="${ctx}/mcd/assets/styles/jqueryUI/jquery-ui-1.11.0.min.css" />
	<link type="text/css" rel="stylesheet" href="${ctx}/mcd/assets/scripts/bootstrap/css/bootstrap.min.css" />
	<link type="text/css" rel="stylesheet" href="${ctx}/mcd/assets/styles/CEP/cep.main.bootstrap.css" />
	<link type="text/css" rel="stylesheet" href="${ctx}/mcd/assets/scripts/My97DatePicker/skin/WdatePicker.css" />
	<link type="text/css" rel="stylesheet" href="${ctx}/mcd/assets/styles/style.css" />
	<link type="text/css" rel="stylesheet" href="${ctx}/mcd/assets/styles/tactics/createTactics.css">
	<link type="text/css" rel="stylesheet" href="${ctx}/mcd/assets/styles//resetDialog-jqueryUI.css">
	<link type="text/css" rel="stylesheet" href="http://api.map.baidu.com/library/DrawingManager/1.4/src/DrawingManager_min.css" />
</head>
					...
					<div class="group-info">
						<div class="group-info-search">
							...
							<div class="group-info-newgroup">
								<a style="text-decoration: none;" target="_blank" href="${ctx}/mcd/pages/custom/addCustom.jsp?navId=7143&subNavId=714312"><span>+</span>
								<span>新建客户群</span></a>
							</div>
...
<div class="chooseNetFlowDialog previewExecontentDialog_902" style="width: 1120px;height: 720px;">
	...
	<div  style="width: 100%;height: 100%;background:url(${ctx}/mcd/assets/images/yulan-bg.jpg);position: absolute;" >
								...
								<div class="marketing-main">
									<div class="marketing-item">
										<div class="marketing-logo">
											<img src="${ctx}/mcd/assets/images/marketing-icon-left.png" class="marketing-icon-left">
										</div>
									...
									<div class="marketing-item marketing-float-right">
										<div class="marketing-logo">
											<img src="${ctx}/mcd/assets/images/marketing-icon-right.png" class="marketing-icon-right">
										</div>
										<div class="marketing-content">
											<div class="marketing-btn">
...
<div class="chooseNetFlowDialog previewExecontentDialog_906" style="width: 1120px;height: 720px;">
	...
	<div  style="width: 100%;height: 100%;background:url(${ctx}/mcd/assets/images/channel-yyt-yl.png) no-repeat 0px -48px;position: absolute;" >
						...
						<ul>
							<li>
								<div class="marketing-main">
									<div class="marketing-item">
										<div class="marketing-logo">
											<img src="${ctx}/mcd/assets/images/channel-yyt-icon-right.png" class="marketing-icon-left">
										</div>
										<div class="marketing-content">
											<div class="marketing-btn">
												<p class="marketing-btn-title"></p>
									...
									<div class="marketing-item marketing-float-right">
										<div class="marketing-logo">
											<img src="${ctx}/mcd/assets/images/channel-yyt-icon-left.png" class="marketing-icon-right">
										</div>
										<div class="marketing-content">
											<div class="marketing-btn">
...
<script type="text/javascript">
	...
	seajs.use(["${ctx}/mcd/assets/scripts/nav/navManage","${ctx}/mcd/assets/scripts/tactics/createTactics"],function(nav,ct){
		 nav.init();
 		ct.ifEditFun(); 
		ct.init();
	});
	seajs.use("${ctx}/mcd/assets/scripts/tactics/main",function(main){
		main.init();
	});
