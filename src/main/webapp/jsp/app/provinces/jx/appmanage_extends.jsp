...
<head>
    ...
    <!-- css内容 -->
    <link rel="stylesheet" type="text/css" href="<%=contextPath%>/assets/css/provinces/<%=provinces%>/app/common.css"><!-- 通用样式 -->
    ...
    <link rel="stylesheet" href="<%=contextPath%>/assets/css/provinces/<%=provinces%>/app/app_dialog.css" type="text/css"><!-- 内容弹窗样式 -->
...
<body>
    ...
    <span class="search-title fleft">应用库</span>
    ...
    <th ><span style="width:97px;">应用编码</span></th>
    <th ><span style="width:130px;">应用名称(标题)</span></th>
    ...
    seajs.use("content/provinces/<%=provinces%>/contentmanage_extends.js",function(contentmanage_extends){
    contentmanage_extends.init();
    });
    </script>
