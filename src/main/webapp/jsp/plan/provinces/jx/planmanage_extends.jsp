...
<head>
    ...
    <!-- css内容 -->
    <link rel="stylesheet" type="text/css" href="<%=contextPath%>/assets/css/provinces/jx/plan/common.css"><!-- 通用样式 -->
    <link href="<%=contextPath%>/assets/css/provinces/jx/plan/plan.css" rel="stylesheet" type="text/css"><!-- 产品样式 -->
    <link href="<%=contextPath%>/assets/css/provinces/jx/plan/plan_table.css" rel="stylesheet" type="text/css"><!-- 产品table样式 -->
    <link rel="stylesheet" href="<%=contextPath%>/assets/css/provinces/jx/plan/plan_dialog.css" type="text/css"><!-- 产品弹窗样式 -->

    <!--js内容-->
    <script src="<%=contextPath%>/assets/js/plan/provinces/jx/planChoose.js" type="text/javascript"></script><!--planChoose.js 选择菜单的视图-->
    <script src="<%=contextPath%>/assets/js/plan/provinces/jx/planList.js" type="text/javascript"></script><!--planList.js 列表数据的视图-->
    <script src="<%=contextPath%>/assets/js/plan/provinces/jx/planDetail.js" type="text/javascript"></script><!--planDetail.js 弹窗数据的视图-->
