 ...
 *
 */
@Service("channelExec3Service")
public class ChannelExec3ServiceImpl extends  msmChartServiceImpl {
	...
	public List<Map<String, String>> getDataInfo(Map<String, Object> paramsMap)
		...
		for (int i = 0; i < list.size(); i++) {
			...
			String camp_succ_rate = String.valueOf( map.get("SUCRATE"));//成功人数
			camp_succ_rate = KpiUtil.parsePercentNoUnit(camp_succ_rate);
			map1.put(OP_ID, camp_succ_rate);
		}
		dataList.add(map1);
		return dataList;
	}
