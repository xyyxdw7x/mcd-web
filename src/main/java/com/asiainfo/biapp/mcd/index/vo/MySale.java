package com.asiainfo.biapp.mcd.index.vo;
...
public class MySale {
	...
	public long getYesterdaySuccessNum() {
		return yesterdaySuccessNum;
	}
	public void setYesterdaySuccessNum(long yesterdaySuccessNum) {
		this.yesterdaySuccessNum = yesterdaySuccessNum;
	}
	public long getMonthSuccessNum() {
		return monthSuccessNum;
	}
	public void setMonthSuccessNum(long monthSuccessNum) {
		this.monthSuccessNum = monthSuccessNum;
	}
