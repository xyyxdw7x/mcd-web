...
public class DeptsQuotaStatisticsDaoImp extends JdbcDaoBase implements
	...
	@Override
	public List<Map<String, Object>> getStatistics(String cityId, String month)
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<Map<String, Object>> getCurrentMonth(String cityId)
			throws DataAccessException {
		...
		String[] parm = { currentMonth, cityId };
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<Map<String, Object>> getCurrentDay(String cityId)
			throws DataAccessException {
		List<Map<String, Object>> list = null;
	...
	@SuppressWarnings("unchecked")
	@Override
	public Map<String, Object> getCityStatis(String cityId)throws DataAccessException {
		...
		String[] parm = { currentMonth, cityId };
		try {
			map = this.sqlFireJdbcTemplate.queryForMap(sql.toString(), parm);
		} catch (DataAccessException e) {
			return null;
		}
		return map;
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> getConfigedCityUsed(String month)
			throws DataAccessException {
		List<Map<String, Object>> list = null;
...
//				+ "on cc.city_id=cu.city_id";
		...
		try {
			list = this.sqlFireJdbcTemplate.queryForList(sql.toString(), parm);
		} catch (DataAccessException e) {
			return null;
		}
		return list;
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> getDeptQuotaStatic(String month) {
		List<Map<String, Object>> list = null;
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<Map<String, Object>> getConfigedDay(String date) {
		List<Map<String, Object>> list = null;
