 ...
 *
 */
public class SignalOnlineOutBean extends NbsBaseBean {
	private static final long serialVersionUID = 5225140009283295183L;
	//非必填项
	...
	private String online_time;//用户上线时间

	public SignalOnlineOutBean() {
		super();
	}
