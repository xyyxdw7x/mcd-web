...
public class CepCONST {
	...
	//获取需要监听的活动
	public static final String QUERY_CEP_EVENT_INIT_SQL_ORACLE = "select campseg_id, cep_event_id from mcd_camp_def where cep_event_id is not null  and  campseg_stat_id in (54,59)";
	
	public static final String QUERY_CEP_EVENT_INIT_SQL = "select campseg_id, cep_event_id from mcd_camp_def where cep_event_id is not null and  campseg_stat_id in (54,59)";
