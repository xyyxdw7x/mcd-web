...
public class McdDimCampStatus implements java.io.Serializable {
	...
	/** default constructor */
	public McdDimCampStatus() {
	}

	/** minimal constructor */
	public McdDimCampStatus(Short campsegStatId) {
		this.campsegStatId = campsegStatId;
	}

	/** full constructor */
	public McdDimCampStatus(Short campsegStatId, String campsegStatName, short visible, String campsegStatDesc) {
		this.campsegStatId = campsegStatId;
