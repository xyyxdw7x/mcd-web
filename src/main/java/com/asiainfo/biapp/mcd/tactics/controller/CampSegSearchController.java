...
public class CampSegSearchController extends BaseMultiActionController {
	...
	public ModelAndView searchIMcdCamp(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String campsegStatId = request.getParameter("campsegStatId");
		...
		if (StringUtils.isNotEmpty(campsegStatId)) {
		...
		JsonUtil.outJson(response, dataJson);
		return null;
	}
	...
	public ModelAndView searchMcdMpmCampSegChild(HttpServletRequest request, HttpServletResponse response)throws Exception {
		int status = 200;
		String msg = "";
	...
	public ModelAndView submitApproval(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String campsegId = request.getParameter("campsegId") != null ? request.getParameter("campsegId") : null;
	...
	public ModelAndView delCampseg(HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	public ModelAndView updateCampsegEndDate(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String msg = "";
		int status = 200;
		try {
			String campsegId = request.getParameter("campsegId") != null ? request.getParameter("campsegId") : null;
	...
	public ModelAndView cancelAssignment(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String campsegId = request.getParameter("campsegId") != null ? request.getParameter("campsegId") : null;
	...
	public ModelAndView campCancel(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String msg = "";
		int status = 200;
		try {
			/* 获取session信息 */
	...
	public ModelAndView campPause(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String msg = "";
		int status = 200;
		try {
			/* 获取session信息 */
